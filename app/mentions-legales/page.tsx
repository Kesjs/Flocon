        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p>
              ...
              de représentation et d'utilisation sont réservés pour l'ensemble des éléments 
              du site, y compris les textes, articles, dessins, images, logos, icônes, etc.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <p>• Paiement : Stripe</p>
              <p>• Images : Unsplash et photographes professionnelles</p>
