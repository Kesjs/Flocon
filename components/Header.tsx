                          ...
                          <div className="py-2">
                            ...
                            >
                              <div className="flex items-center space-x-3">
                                ...
                                <span className="text-textDark group-hover:text-rose transition-colors">Tableau de bord</span>
                              </div>
                            ...
                            >
                              <div className="flex items-center space-x-3">
                                ...
                                <span className="text-textDark group-hover:text-rose transition-colors">Mes commandes</span>
                              </div>
                              <ChevronRight className="w-4 h-4 text-gray-400" />
                            </Link>
                            ...
                            >
                              <div className="flex items-center space-x-3">
                                ...
                                <span className="text-textDark group-hover:text-rose transition-colors">Ma wishlist</span>
                              </div>
                              <ChevronRight className="w-4 h-4 text-gray-400" />
                            </Link>
                          </div>
